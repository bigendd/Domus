 ...
 */
final class Version20241119180450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE details_realisation CHANGE realisation_id realisation_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE details_realisation DROP FOREIGN KEY FK_81DF4BF1B685E551');
        $this->addSql('ALTER TABLE details_realisation CHANGE realisation_id realisation_id INT DEFAULT NULL');
